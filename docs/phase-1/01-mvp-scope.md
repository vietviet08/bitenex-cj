...
- Enable event tracking via a JavaScript Web SDK embedded in any website (including Spring Boot + Thymeleaf pages).
...
- Mobile SDKs (iOS/Android) beyond the Web SDK.
