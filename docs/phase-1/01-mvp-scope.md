...
- Onboarding to first order.
- Abandoned checkout recovery.
- Delivered to review and reorder.
...
- [ ] n8n workflows for onboarding to first order, abandoned checkout recovery, and delivered to review plus reorder
